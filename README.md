...
all-in-one filterlist combining all lists used in https://github.com/Willie169/combinedfox/wiki/my-ublock-backup.txt, designed for situations where using single list is the only option or more convenient, such as Content Filtering of Brave for Android
